...
So how do you begin? It's really simple and also follows unique naming convention you begin with a clay object with New (emphasis on uppercase 'N')
...
```
you can pass anonymous objects and also accepts named arguments, you can also use jQuery style chainable setters or put use them as an array
