...
Progressive scan is simple, it draws all the pixels from left to right then top to bottom in a progressive manner, Interlaced video is a bit different, it first draws the odd lines first, and then the even lines are filled up in gaps left, Interlaced video saves bandwidth, which was the reason why it was created in the first place.
...
So we might say this as **576i** So we will be getting a resolution of 384x288 in a 4:3 picture ratio. and for records sake NTSC is 480i at 30fps,

And now comes the HDTV, HDTV is most of the cases is used broadly and has many resolutions. so you can be a bit confused by companies saying that their TV is HDTV, So I think you can now understand what those things mean when they say the TV is 720p, 1080i.
...
Now the next things are also in the works: UHDTV, Ultra High Definition 2540p and 4320p.
