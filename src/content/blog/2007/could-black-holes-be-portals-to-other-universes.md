...
And there might be a way to test the conjecture. Some physicists say that future particle accelerator experiments could produce microscopic black holes. Such tiny black holes would emit measurable amounts of Hawking radiation, proving that they are black holes rather than wormholes. But if Solodukhin is right, and microscopic wormholes are formed instead, no such radiation would be expected. "In that case, you would actually see if it is a black hole or a wormhole," he says.
