---
title: "Using an ASP.NET Grid View Using Code"
description: ""
...
We have all used grid view along with data sources but sometimes you need to do that from code. The problem is most of us do not know how to use this from code, but it's not that difficult to do. Here's a simple way to do that.

A simple grid: first column is a readonly templated field, second one a readonly bound field, and third a templated entry field. At the end is the edit command field.
